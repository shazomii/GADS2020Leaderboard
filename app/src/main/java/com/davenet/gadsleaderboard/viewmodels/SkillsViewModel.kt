...
/**
 * SkillsViewModel designed to store and manage UI-related data in a lifecycle conscious way. This
...
class SkillsViewModel(application: Application) : AndroidViewModel(application) {
     ...
     */
    private val skillRepository = SkillsRepository(getDatabase(application))

    /**
     * A list of learners displayed on the screen.
     */
    val learnersList = skillRepository.skills
